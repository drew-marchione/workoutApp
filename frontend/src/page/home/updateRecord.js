...
export class UpdateRecord extends InnerPage {
    ...
    update(selectedExerciseName) {
        ...
        console.log("Update: ", selectedExerciseName);
        let exerciseModalData = this.exercises.filter(x => x.name == selectedExerciseName)[0];
        console.log("Update exercise", exerciseModalData);
        this.dialogService.open({ viewModel: UpdateRecordModal, model: exerciseModalData , lock: false });
